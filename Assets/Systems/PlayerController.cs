...
public class PlayerController : MonoBehaviour
{
    ...
    private void RaycastFiredInput() 
    {
        RaycastHit hit;
        ...
        if (Physics.Raycast(mainCam.transform.position, mainCam.transform.forward, out hit, 10f, ~ignoreMask))
        {
            ...
            Debug.Log("Did hit: " + hit.collider.gameObject.name + Vector3.Distance(mainCam.transform.position, hit.transform.position));
            Debug.DrawRay(mainCam.transform.position, mainCam.transform.forward *10f, Color.red);
            ...
            if (hit.collider.gameObject.CompareTag("Target"))
            {
                ...
                hitColor.material.color = myColor;
                myColor = new Color(Random.Range(0f, 1f), Random.Range(0f, 1f), Random.Range(0f, 1f));
            }
        ...
        {
            Debug.DrawRay(mainCam.transform.position, mainCam.transform.forward * 10, Color.green);
    ...
    private void OnEnable()
    {
        ...
        inputManager.FireRaycastEvent += RaycastFiredInput; 
    }
